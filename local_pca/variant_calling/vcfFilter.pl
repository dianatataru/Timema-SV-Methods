...
## 238 inds, 2x
my $minCoverage = 676; # minimum number of sequences; DP
my $minAltRds = 10; # minimum number of sequences with the alternative allele; AC
my $notFixed = 1.0; # removes loci fixed for alt; AF
my $bqrs = 4; # Z-score base quality rank sum test; BaseQRankSum
my $mqrs = 4; # Z-score mapping quality rank sum test; MQRankSum
my $rprs = 4; # Z-score read position rank sum test; ReadPosRankSum
my $mq = 30; # minimum mapping quality; MQ
my $miss = 47; # maximum number of individuals with no data = 20%=47
##### this set is for GBS aligned to pangenome (relaxed filtering)
my $d;
